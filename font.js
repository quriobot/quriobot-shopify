export const fonts = {
  webfonts: {
    ...
    google: {
      ...
      fonts: {
        ...
        "Baloo Bhai": [
          ["normal"],
          ["latin-ext", "latin", "vietnamese", "gujarati"],
        ],
        "Baloo Bhaijaan": [
          ["normal"],
        ...
        "Baloo Bhaina": [
          ["normal"],
          ["latin-ext", "latin", "vietnamese", "oriya"],
        ],
        "Baloo Chettan": [
          ["normal"],
          ["malayalam", "latin-ext", "latin", "vietnamese"],
        ],
        "Baloo Da": [
          ["normal"],
          ["bengali", "latin-ext", "latin", "vietnamese"],
        ],
        "Baloo Paaji": [
          ["normal"],
          ["latin-ext", "latin", "vietnamese", "gurmukhi"],
        ],
        "Baloo Tamma": [
          ["normal"],
          ["latin-ext", "kannada", "latin", "vietnamese"],
        ],
        "Baloo Tammudu": [
          ["normal"],
          ["telugu", "latin-ext", "latin", "vietnamese"],
        ],
        "Baloo Thambi": [
          ["normal"],
          ["latin-ext", "latin", "vietnamese", "tamil"],
  ...
  defaultstyles: ["normal", "italic", "700", "700italic"],
  googlestyles: {
    100: "Thin 100",
    200: "Extra-Light 200",
    300: "Light 300",
